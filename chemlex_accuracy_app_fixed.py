...
with tab1:
    ...
    # Sort before selecting display columns. If we select table_cols first, abs_gap is dropped and pandas raises KeyError.
    table = material.sort_values("abs_gap", ascending=False).head(100)[table_cols].copy()
